...
BINDING_HEADER_OBJECTMANIP, SLASH_SHOWCLOSE1, SLASH_SHOWCLOSE2 = "Things Mover", "/thingsm", "/tm"
...
function ThingToMove()
   if ObjectToggle:GetChecked() then
      return "go"
   end
   if ObjectGroupToggle:GetChecked() then
      return "go group"
   end
   if NPCToggle:GetChecked() then
      return "npc"
   end
end
		...
		if OPMoveObjectInstead:GetChecked() then
			if RelativeToPlayer:GetChecked() then
				--OPMoveRelative("forward")
                                cmd(ThingToMove().." relative forward "..OPmoveLength)
			else
				cmd(ThingToMove().." move for "..OPmoveLength)
			end
		else
...
function OPBackward()
	...
	if OPmoveLength and OPmoveLength ~= "" and OPmoveLength ~= 0 and OPmoveLength ~= nil then
		if OPMoveObjectInstead:GetChecked() == true then
			if RelativeToPlayer:GetChecked() then
				--OPMoveRelative("back")
				cmd(ThingToMove().." relative back "..OPmoveLength)
			else
				cmd(ThingToMove().." move back "..OPmoveLength)
			end
		else
...
function OPLeft()
	...
	if OPmoveWidth and OPmoveWidth ~= "" and OPmoveWidth ~= 0 and OPmoveWidth ~= nil then
		if OPMoveObjectInstead:GetChecked() == true then
			if RelativeToPlayer:GetChecked() then
				--OPMoveRelative("left")
				cmd(ThingToMove().." relative left "..OPmoveWidth)
			else
				cmd(ThingToMove().." move left "..OPmoveWidth)
			end
		else
	...
	if OPmoveWidth and OPmoveWidth ~= "" and OPmoveWidth ~= 0 and OPmoveWidth ~= nil then
		if OPMoveObjectInstead:GetChecked() == true then
			if RelativeToPlayer:GetChecked() then
				...
				cmd(ThingToMove().." relative right "..OPmoveWidth)
			else
				cmd(ThingToMove().." move right "..OPmoveWidth)
			end
		else
...
function OPUp()
	...
	if OPmoveHeight and OPmoveHeight ~= "" and OPmoveHeight ~= 0 and OPmoveHeight ~= nil then
		if OPMoveObjectInstead:GetChecked() == true then
			cmd(ThingToMove().." move up "..OPmoveHeight)
		else
...
function OPDown()
	...
	if OPmoveHeight and OPmoveHeight ~= "" and OPmoveHeight ~= 0 and OPmoveHeight ~= nil then
		if OPMoveObjectInstead:GetChecked() == true then
			cmd(ThingToMove().." move down "..OPmoveHeight)
		else
...
function OPRotateObject()
	...
	if RotationY < 0 then RotationY = 0; if OPMasterTable.Options["debug"] then print("RotY < 0, Made 0") end; end
        ...
        if ObjectToggle:GetChecked() then
           ...
           cmd(ThingToMove().." turn "..RotationZ)
        end
end
